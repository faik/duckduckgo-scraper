...
flow.create('f212efc9-113b-4d06-8732-ada8e0ab2c99', 'Duck Duck External', (f) => {
  f.node('dd39a8', 'Core.Trigger.Inject', 'Start', {})
    ...
    .then('f4a190', 'Core.Browser.ClickElement', 'Search', { inSelector: Custom('//body/div/div/div/main/article/div[1]/div[1]/div[2]/div/header/div/section[2]/div/form/div/div[3]/button') })
